...
(function (global, factory) {
  ...
  function formatDayOfYear(d, p) {
    return pad$1(1 + day.count(year(d), d), p, 2);
  }

  function formatMilliseconds(d, p) {
    return pad$1(d.getMilliseconds(), p, 2);
  }
  ...
  function formatUTCDayOfYear(d, p) {
    return pad$1(1 + utcDay.count(utcYear(d), d), p, 2);
  }

  function formatUTCMilliseconds(d, p) {
    return pad$1(d.getUTCMilliseconds(), p, 2);
  }
