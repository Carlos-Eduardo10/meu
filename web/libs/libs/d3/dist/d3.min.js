...
!(function (t, n) {
  ...
  function we(t, n) {
    var e,
      r,
      i,
      o = (me.lastIndex = xe.lastIndex = 0),
      a = -1,
      u = [],
      c = [];
    for (t += "", n += ""; (e = me.exec(t)) && (r = xe.exec(n)); )
      (i = r.index) > o &&
        ...
        (function (t, n, e, o) {
          t !== n
            ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360),
              o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: _e(t, n) }))
            : n && e.push(i(e) + "rotate(" + n + r);
        })(o.rotate, a.rotate, u, c),
        (function (t, n, e, o) {
          t !== n
            ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: _e(t, n) })
      ...
      function (t) {
        return "none" === t
          ...
          : (Te ||
            ...
            (t = Se.getComputedStyle(Ae.appendChild(Te), null).getPropertyValue(
              "transform"
            )),
            Ae.removeChild(Te),
            Pe(
  ...
  function lr() {
    ur(), ++Ke;
    for (var t, n = Ze; n; )
      (t = rr - n._time) >= 0 && n._call.call(null, t), (n = n._next);
    --Ke;
  }
  function hr() {
  ...
  function pr(t) {
    Ke ||
      ...
      t - rr > 24
        ? (t < 1 / 0 && (Je = setTimeout(hr, t - or.now() - ir)),
          tr && (tr = clearInterval(tr)))
        : (tr || ((er = or.now()), (tr = setInterval(dr, nr))),
          (Ke = 1),
          ar(hr)));
  }
  function vr(t, n, e) {
    ...
    !(function (t, n, e) {
      ...
      function o(c) {
        ...
        if (
          (vr(function () {
            e.state === xr &&
              ((e.state = wr), e.timer.restart(a, e.delay, e.time), a(c));
          }),
          (e.state = mr),
          ...
          for (
            e.state = xr, r = new Array((l = e.tween.length)), f = 0, s = -1;
            f < l;
            ++f
          )
  ...
  (zt.prototype.interrupt = function (t) {
    ...
    (zt.prototype.transition = function (t) {
      ...
      t instanceof qr
        ? ((n = t._id), (t = t._name))
        : ((n = Ur()), ((e = di).time = ur()), (t = null == t ? null : t + ""));
      for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
        for (var a, u = r[o], c = u.length, f = 0; f < c; ++f)
          (a = u[f]) && Tr(a, t, n, f, u, e || pi(a, n));
  ...
  function Bi(n) {
    ...
    function d() {
      ...
      function I() {
        ...
        h < o &&
          ...
          (o = h),
          (h = t),
          m in Ci && B.attr("cursor", Ei[(m = Ci[m])])),
          p < c &&
            ((M *= -1),
            (t = u),
            (u = d),
            ...
            (c = p),
            (p = t),
            m in Pi && B.attr("cursor", Ei[(m = Pi[m])])),
    ...
    return (
      ...
      (h.prototype = {
        ...
        emit: function (t) {
          kt(new yi(f, t, n.output(this.state.selection)), u.apply, u, [
            t,
            this.that,
            this.args,
          ]);
      ...
      (f.extent = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : gi(Ti(t))), f)
          : r;
      }),
      (f.filter = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : gi(!!t)), f)
          : i;
      }),
      (f.touchable = function (t) {
        return arguments.length
          ? ((o = "function" == typeof t ? t : gi(!!t)), f)
          : o;
      }),
    ...
    function o(e, i) {
      ...
      return (
        (function (e, r, i) {
          ...
          for (; ++o < t - 1; )
            (c = f), (f = e[o + 1] >= r), wo[c | (f << 1)].forEach(p);
          wo[f << 0].forEach(p);
          for (; ++u < n - 1; ) {
            for (
              o = -1,
    ...
    function r(t, n) {
      ...
      function s() {
        ...
        if (t.charCodeAt(i) === Po) {
          for (
            ;
            (a++ < o && t.charCodeAt(a) !== Po) || t.charCodeAt(++a) === Po;
      ...
      for (
        t.charCodeAt(o - 1) === zo && --o, t.charCodeAt(o - 1) === Ro && --o;
        (r = s()) !== Co;
  ...
  (Ma.copy = function () {
    var t,
      n,
      e = new xa(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
      r = this._root;
    if (!r) return e;
    ...
    (Ma.visit = function (t) {
      var n,
        ...
        c = this._root;
      for (
        c && u.push(new ya(c, this._x0, this._y0, this._x1, this._y1));
        (n = u.pop());
        ...
        if (
          ...
          var f = (r + o) / 2,
            s = (i + a) / 2;
          (e = c[3]) && u.push(new ya(e, f, s, o, a)),
            (e = c[2]) && u.push(new ya(e, r, s, f, a)),
            (e = c[1]) && u.push(new ya(e, f, i, o, s)),
            (e = c[0]) && u.push(new ya(e, r, i, f, s));
        }
      return this;
    }),
    (Ma.visitAfter = function (t) {
      ...
      for (
        this._root &&
        e.push(new ya(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
        ...
        if (i.length) {
          var o,
            ...
            s = (a + c) / 2,
            l = (u + f) / 2;
          (o = i[0]) && e.push(new ya(o, a, u, s, l)),
            (o = i[1]) && e.push(new ya(o, s, u, c, l)),
            (o = i[2]) && e.push(new ya(o, a, l, s, f)),
            (o = i[3]) && e.push(new ya(o, s, l, c, f));
        }
        r.push(n);
      }
  ...
  var Ba = {
    ...
    s: function (t, n) {
      ...
      return o === a
        ...
        : "0." + new Array(1 - o).join("0") + za(t, Math.max(0, n + o - 1))[0];
    },
    X: function (t) {
  ...
  function Xa(n) {
    return (
      (Ya = ja(n)),
      (t.format = Ya.format),
      (t.formatPrefix = Ya.formatPrefix),
      Ya
    );
  }
  function Va(t) {
  ...
  function Ga(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor(Ra(n) / 3))) - Ra(Math.abs(t))
    );
  }
  function $a(t, n) {
    return (
      (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, Ra(n) - Ra(t)) + 1
    );
  }
  function Wa() {
    return new Za();
  ...
  Xa({
    ...
    (Za.prototype = {
      ...
      add: function (t) {
        Ka(Qa, t, this.t),
          Ka(this, Qa.s, this.s),
          this.s ? (this.t += Qa.t) : (this.s = Qa.t);
      },
      valueOf: function () {
        return this.s;
      },
  ...
  var Eu,
    ...
    Lu = {
      ...
      polygonEnd: function () {
        var t = +Du;
        qu.add(t < 0 ? iu + t : t),
          (this.lineStart = this.lineEnd = this.point = wu);
      },
      sphere: function () {
        qu.add(iu);
      },
  ...
  function Zc(t) {
    ...
    return (
      (t = Vc(t[0] * au, t[1] * au, t.length > 2 ? t[2] * au : 0)),
      (n.invert = function (n) {
  ...
  function Qc(t, n, e, r, i, o) {
    if (e) {
      ...
      for (var f, s = i; r > 0 ? s > o : s < o; s -= c)
        (f = Yu([a, -u * su(s), -u * vu(s)])), t.point(f[0], f[1]);
    }
  }
  function Kc(t, n) {
    ((n = Iu(n))[0] -= t), Gu(n);
      ...
      (t.forEach(function (t) {
        if (!((n = t.length - 1) <= 0)) {
          ...
          if (tf(r, a)) {
            ...
            u.push((e = new nf(r, t, null, !0))),
              c.push((e.o = new nf(r, null, e, !1))),
              u.push((e = new nf(a, t, null, !1))),
              c.push((e.o = new nf(a, null, e, !0)));
        }
      }),
      u.length)
    ) {
      for (c.sort(n), rf(u), rf(c), o = 0, a = c.length; o < a; ++o)
        c[o].e = e = !e;
      for (var f, s, l = u[0]; ; ) {
      ...
      var o,
        ...
        h = {
          ...
          polygonEnd: function () {
            ...
            var t = uf(o, r);
            a.length
              ? (l || (i.polygonStart(), (l = !0)), ef(a, sf, t, e, i))
              : t &&
  ...
  function sf(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - eu - Ja : eu - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - eu - Ja : eu - n[1])
    );
  }
  var lf = cf(
    function () {
        ...
        return {
          ...
          point: function (l, h) {
            ...
            if (
              (!n && (f = c = v) && t.lineStart(),
              v !== c &&
                (!(d = a(n, p)) || tf(n, d) || tf(p, d)) &&
                ((p[0] += Ja), (p[1] += Ja), (v = o(p[0], p[1]))),
              v !== c)
            )
              (s = 0),
                v
    ...
    return function (a) {
      ...
      function M(o, a) {
        ...
        if ((f && s.push([o, a]), y))
          ...
          var c = [
              (p = Math.max(pf, Math.min(df, p))),
              (v = Math.max(pf, Math.min(df, v))),
            ],
            m = [
              (o = Math.max(pf, Math.min(df, o))),
              (a = Math.max(pf, Math.min(df, a))),
            ];
  ...
  function Of() {
    ...
    function b() {
      return g(lu(r / p) * p, e, p)
        .map(s)
        .concat(g(lu(u / v) * v, a, v).map(l))
        .concat(
          g(lu(n / h) * h, t, h)
            .filter(function (t) {
              return uu(t % p) > Ja;
      ...
      switch (this._point) {
        ...
        default:
          this._context.moveTo(t + this._radius, n),
            this._context.arc(t, n, this._radius, 0, iu);
      }
    },
    result: wu,
  };
    ...
    point: function (t, n) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        default:
          null == this._circle && (this._circle = Ls(this._radius)),
    ...
    return +n
      ? (function (t, n) {
          function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
            ...
            if (b > 4 * n && v--) {
              var m = a + h,
                ...
                N = mu((w /= M)),
                T =
                  uu(uu(w) - 1) < Ja || uu(o - l) < Ja ? (o + l) / 2 : fu(x, m),
                A = t(T, N),
                S = A[0],
                k = A[1],
                E = S - r,
          ...
          return function (n) {
            ...
            function w() {
              e(s, l, f, h, d, p, i, o, r, a, u, c, js, n),
                (v.lineEnd = b),
                b();
            }
            return v;
  ...
  function Zs(t) {
    ...
    function S() {
      ...
      return (
        (e = Vc(g, y, _)), (u = jc(n, r)), (c = jc(e, u)), (a = Vs(u, N)), k()
      );
    }
    function k() {
      return (f = s = null), T;
  ...
  function gl(t, n) {
    var e = mu(vl * vu(n)),
      ...
      i = r * r * r;
    return [
      (t * su(e)) / (vl * (ll + 3 * hl * r + i * (7 * dl + 9 * pl * r))),
      e * (ll + hl * r + i * (dl + pl * r)),
    ];
  }
  function yl(t, n) {
    ...
    for (null == n && (n = kl); (e = f.pop()); )
      if ((c && (e.value = +e.data.value), (i = n(e.data)) && (a = i.length)))
        for (e.children = new Array(a), o = a - 1; o >= 0; --o)
          f.push((r = e.children[o] = new Pl(i[o]))),
            (r.parent = e),
            (r.depth = e.depth + 1);
  ...
  (gl.invert = function (t, n) {
    ...
    return [
      (vl * t * (ll + 3 * hl * i + o * (7 * dl + 9 * pl * i))) / su(r),
      mu(vu(r) / vl),
    ];
  }),
    (yl.invert = el(cu)),
    (bl.invert = function (t, n) {
      var e,
        r = n,
        i = 25;
      do {
  ...
  function Rl(t) {
    for (
      ...
      (n = t[r]), e && Ll(e, n) ? ++r : ((e = Ol((o = Dl(o, n)))), (r = 0));
    return e;
  }
  function Dl(t, n) {
    var e, r;
  ...
  function Xl(t) {
    ...
    t: for (u = 3; u < i; ++u) {
      ...
      for (
        r.previous = n, r.next = e, n.next = e.previous = e = r, o = Hl(n);
        (r = r.next) !== e;
  ...
  function vh(t, n, e, r, i, o) {
    for (
      ...
      y.push((a = { value: s, dice: c < f, children: _.slice(b, m) })),
        a.dice
          ? nh(a, e, r, i, w ? (r += (f * s) / w) : o)
          : dh(a, e, r, w ? (e += (c * s) / w) : i, o),
        (w -= s),
        (b = m);
    }
    return y;
      ...
      if ((a = t._squarify) && a.ratio === n)
        for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
          for (
            ...
            u.value += c[f].value;
          u.dice
            ? nh(u, e, r, i, (r += ((o - r) * u.value) / d))
            : dh(u, e, r, (e += ((i - e) * u.value) / d), o),
            (d -= u.value);
        }
  ...
  function jh() {
    ...
    function s() {
      return (
        (r = Math.min(a.length, u.length) > 2 ? Ih : Yh), (i = o = null), l
      );
    }
    function l(n) {
  ...
  function Vh(n, e, r, i) {
    ...
    switch ((i = La(null == i ? ",f" : i)).type) {
      case "s":
        ...
        return (
          null != i.precision || isNaN((o = Ga(a, u))) || (i.precision = o),
          t.formatPrefix(i, u)
        );
      case "":
      case "e":
      ...
      case "r":
        null != i.precision ||
          isNaN((o = $a(a, Math.max(Math.abs(n), Math.abs(e))))) ||
  ...
  function nd(n) {
    ...
    function u() {
      return (
        ...
        o()[0] < 0 ? ((e = td(e)), (r = td(r)), n(Qh, Kh)) : n(Wh, Zh),
        i
      );
    }
    return (
  ...
  function cd(t) {
    var n = t(Oh, Oh),
      e = 1;
    function r() {
      return 1 === e ? t(Oh, Oh) : 0.5 === e ? t(ad, ud) : t(od(e), od(1 / e));
    }
    return (
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            sd.setTime(+n), ld.setTime(+r), t(sd), t(ld), Math.floor(e(sd, ld))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  var pd = dd.range,
    ...
    xd = hd(
      function (t) {
        t.setTime(
          t - t.getMilliseconds() - 1e3 * t.getSeconds() - t.getMinutes() * vd
        );
      },
      function (t, n) {
        t.setTime(+t + 36e5 * n);
    ...
    Md = hd(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * vd) / 864e5
        );
      },
      function (t) {
        return t.getDate() - 1;
  ...
  function Td(t) {
    return hd(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * vd) / gd
        );
      }
    );
  }
    ...
    function M(t, n) {
      return function (e) {
        ...
        if (
          ...
          "w" in o || (o.w = 1),
            "Z" in o
              ? ((i = (r = gp(yp(o.y, 0, 1))).getUTCDay()),
                (r = i > 4 || 0 === i ? Kd.ceil(r) : Kd(r)),
                (r = $d.offset(r, 7 * (o.V - 1))),
                (o.y = r.getUTCFullYear()),
                (o.m = r.getUTCMonth()),
                (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
              : ((i = (r = vp(yp(o.y, 0, 1))).getDay()),
                (r = i > 4 || 0 === i ? Sd.ceil(r) : Sd(r)),
                (r = Md.offset(r, 7 * (o.V - 1))),
                (o.y = r.getFullYear()),
                (o.m = r.getMonth()),
    ...
    function N(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (
            ((i = n.charAt(a++)),
            !(o = x[i in mp ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
  ...
  function Qp(t, n) {
    return Np(1 + Md.count(Id(t), t), n, 2);
  }
  function Kp(t, n) {
    return Np(t.getMilliseconds(), n, 2);
  }
  function Jp(t, n) {
    return Kp(t, n) + "000";
  }
  ...
  function ov(t, n) {
    var e = t.getDay();
    return (
      (t = e >= 4 || 0 === e ? Cd(t) : Cd.ceil(t)),
      Np(Cd.count(Id(t), t) + (4 === Id(t).getDay()), n, 2)
    );
  }
  function av(t) {
    return t.getDay();
  ...
  function pv(t, n) {
    return Np(1 + $d.count(dp(t), t), n, 2);
  }
  function vv(t, n) {
    return Np(t.getUTCMilliseconds(), n, 2);
  }
  function gv(t, n) {
    return vv(t, n) + "000";
  }
  ...
  function wv(t, n) {
    var e = t.getUTCDay();
    return (
      (t = e >= 4 || 0 === e ? np(t) : np.ceil(t)),
      Np(np.count(dp(t), t) + (4 === dp(t).getUTCDay()), n, 2)
    );
  }
  function Mv(t) {
    return t.getUTCDay();
  ...
  function Pv(n) {
    return (
      (bp = _p(n)),
      (t.timeFormat = bp.format),
      (t.timeParse = bp.parse),
      (t.utcFormat = bp.utcFormat),
      (t.utcParse = bp.utcParse),
      bp
    );
  }
  Pv({
  ...
  var ug = new Array(3)
    ...
    oy = new Array(3)
      ...
      .map(Wv),
    ay = ag(oy);
  var uy = We(ee(300, 0.5, 0), ee(-240, 0.5, 1)),
    cy = We(ee(-100, 0.75, 0.35), ee(80, 1.5, 0.8)),
    fy = We(ee(260, 0.75, 0.35), ee(80, 1.5, 0.8)),
    sy = ee();
  var ly = _n(),
    hy = Math.PI / 3,
    dy = (2 * Math.PI) / 3;
  ...
  function Iy() {
    ...
    return (
      (a.x = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : by(+n)), a)
          : t;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : by(+t)), a)
          : n;
      }),
      (a.defined = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : by(!!t)), a)
          : e;
      }),
      (a.curve = function (t) {
  ...
  function Hy() {
    ...
    return (
      (c.x = function (e) {
        return arguments.length
          ? ((t = "function" == typeof e ? e : by(+e)), (n = null), c)
          : t;
      }),
      (c.x0 = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : by(+n)), c)
          : t;
      }),
      (c.x1 = function (t) {
        return arguments.length
          ? ((n = null == t ? null : "function" == typeof t ? t : by(+t)), c)
          : n;
      }),
      (c.y = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : by(+t)), (r = null), c)
          : e;
      }),
      (c.y0 = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : by(+t)), c)
          : e;
      }),
      (c.y1 = function (t) {
        return arguments.length
          ? ((r = null == t ? null : "function" == typeof t ? t : by(+t)), c)
          : r;
      }),
      (c.lineX0 = c.lineY0 =
        function () {
  ...
  function e_(t) {
    ...
    return (
      ...
      (a.x = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : by(+t)), a)
          : r;
      }),
      (a.y = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : by(+t)), a)
          : i;
      }),
      (a.context = function (t) {
    ...
    x_ = {
      draw: function (t, n) {
        ...
        t.moveTo(r, i),
          t.lineTo(o, a),
          t.lineTo(u, c),
          t.lineTo(-0.5 * r - __ * i, __ * r + -0.5 * i),
          t.lineTo(-0.5 * o - __ * a, __ * o + -0.5 * a),
          t.lineTo(-0.5 * u - __ * c, __ * u + -0.5 * c),
          t.lineTo(-0.5 * r + __ * i, -0.5 * i - __ * r),
          t.lineTo(-0.5 * o + __ * a, -0.5 * a - __ * o),
          t.lineTo(-0.5 * u + __ * c, -0.5 * c - __ * u),
          t.closePath();
      },
    },
  ...
  function V_(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i);
    return (
      (X_(o) + X_(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function G_(t, n) {
  ...
  function gb(t, n, e, r) {
    ...
    return (
      ...
      e && _b(i, t, n, e),
      r && _b(i, n, t, r),
      Ob[t.index].halfedges.push(o),
      Ob[n.index].halfedges.push(o),
      i
    );
  }
  function yb(t, n, e) {
      ...
      lineEnd: function () {
        ...
        if (e)
          if (
            ...
            for (var r = J_(t), i = J_(n), o = 0, a = 1; a < e; ++o, ++a)
      ...
      insert: function (t, n) {
        ...
        for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
          e === (r = e.U).L
            ? (i = r.R) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.R && (db(this, e), (e = (t = e).U)),
                (e.C = !1),
                (r.C = !0),
                pb(this, r))
            : (i = r.L) && i.C
            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
            : (t === e.L && (pb(this, e), (e = (t = e).U)),
              (e.C = !1),
              (r.C = !0),
              db(this, r)),
            (e = t.U);
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === i.L) {
                if (
                  ((n = i.R).C &&
                    ((n.C = !1), (i.C = !0), db(this, i), (n = i.R)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  (n.R && n.R.C) ||
                    ((n.L.C = !1), (n.C = !0), pb(this, n), (n = i.R)),
                    (n.C = i.C),
                    (i.C = n.R.C = !1),
                    db(this, i),
                    (t = this._);
                ...
                ((n = i.L).C &&
                  ((n.C = !1), (i.C = !0), pb(this, i), (n = i.L)),
                (n.L && n.L.C) || (n.R && n.R.C))
              ) {
                (n.L && n.L.C) ||
                  ((n.R.C = !1), (n.C = !0), db(this, n), (n = i.L)),
                  (n.C = i.C),
                  (i.C = n.L.C = !1),
                  pb(this, i),
                  (t = this._);
  ...
  function kb(t) {
    var n = t.circle;
    n &&
      (n.P || (Nb = n.N), Bb.remove(n), Tb.push(n), hb(n), (t.circle = null));
  }
  var Eb = [];
  function Cb() {
  ...
  function Rb(t) {
    ...
    for (
      var c = o;
      c.circle &&
      Math.abs(e - c.circle.x) < Yb &&
      Math.abs(r - c.circle.cy) < Yb;

    )
      (o = c.P), u.unshift(c), zb(c), (c = o);
    u.unshift(c), kb(c);
    for (
      var f = a;
      f.circle &&
      Math.abs(e - f.circle.x) < Yb &&
      Math.abs(r - f.circle.cy) < Yb;

    )
      (a = f.N), u.push(f), zb(f), (f = a);
    u.push(f), kb(f);
    var s,
      l = u.length;
    for (s = 1; s < l; ++s)
      (f = u[s]), (c = u[s - 1]), _b(f.edge, c.site, f.site, i);
    (c = u[0]),
      ((f = u[l - 1]).edge = gb(c.site, f.site, null, i)),
      Sb(c),
      Sb(f);
  }
  function Db(t) {
    ...
    if ((Ub.insert(n, c), n || e)) {
      ...
      if (e) {
        ...
        _b(e.edge, f, p, m),
          (c.edge = gb(f, t, null, m)),
          (e.edge = gb(t, p, null, m)),
          Sb(n),
          Sb(e);
  ...
  function Xb(t, n) {
    ...
    for (Fb = [], Ob = new Array(t.length), Ub = new lb(), Bb = new lb(); ; )
      if (((i = Nb), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
        (o[0] === e && o[1] === r) || (Db(o), (e = o[0]), (r = o[1])),
          (o = t.pop());
      else {
        if (!i) break;
        Rb(i.arc);
    ...
    if (
      ...
      var a = +n[0][0],
        ...
        f = +n[1][1];
      !(function (t, n, e, r) {
        for (var i, o = Fb.length; o--; )
          (mb((i = Fb[o]), t, n, e, r) &&
            bb(i, t, n, e, r) &&
            (Math.abs(i[0][0] - i[1][0]) > Yb ||
              Math.abs(i[0][1] - i[1][1]) > Yb)) ||
            delete Fb[o];
      })(a, u, c, f),
        (function (t, n, e, r) {
          var i,
            ...
            if ((o = Ob[i])) {
              ...
              for (u = 0, f = c.length; u < f; )
                (p = (d = Mb(o, Fb[c[u]]))[0]),
                  ...
                  (l = (s = wb(o, Fb[c[++u % f]]))[0]),
                  (h = s[1]),
                  (Math.abs(p - l) > Yb || Math.abs(v - h) > Yb) &&
                    (c.splice(
                      u,
                      0,
                      Fb.push(
                        yb(
                          a,
                          d,
                          Math.abs(p - t) < Yb && r - v > Yb
                            ? [t, Math.abs(l - t) < Yb ? h : r]
                            : Math.abs(v - r) < Yb && e - p > Yb
                            ? [Math.abs(h - r) < Yb ? l : e, r]
                            : Math.abs(p - e) < Yb && v - n > Yb
                            ? [e, Math.abs(l - e) < Yb ? h : n]
                            : Math.abs(v - n) < Yb && p - t > Yb
                            ? [Math.abs(h - n) < Yb ? l : t, n]
                            : null
                        )
                      ) - 1
                    ),
          ...
          for (i = 0; i < g; ++i)
            (o = Ob[i]) && (o.halfedges.length || delete Ob[i]);
        })(a, u, c, f);
    }
  ...
  (Xb.prototype = {
    ...
    ($b.prototype = {
      ...
      translate: function (t, n) {
        return (0 === t) & (0 === n)
          ? this
          : new $b(this.k, this.x + this.k * t, this.y + this.k * n);
      },
      apply: function (t) {
  ...
  (Zb.prototype = $b.prototype),
    (t.FormatSpecifier = Ua),
    (t.active = function (t, n) {
      ...
      if (i)
        for (r in ((n = null == n ? null : n + ""), i))
          if ((e = i[r]).state > br && e.name === n)
            return new qr([[t]], vi, n, +r);
      return null;
    }),
    (t.arc = function () {
      var t = zy,
      ...
      function c() {
        ...
        if ((u || (u = c = Ji()), l < s && ((f = l), (l = s), (s = f)), l > Sy))
          if (p > Cy - Sy)
            u.moveTo(l * wy(h), l * Ty(h)),
              u.arc(0, 0, l, h, d, !v),
              s > Sy &&
                (u.moveTo(s * wy(d), s * Ty(d)), u.arc(0, 0, s, d, h, v));
          else {
            var g,
              y,
              _ = h,
                  ...
                  k < A
                    ...
                    : (u.arc(
                      ...
                      u.arc(
                        ...
                        0,
                        l,
                        xy(g.cy + g.y11, g.cx + g.x11),
                        xy(y.cy + y.y11, y.cx + y.x11),
                        !v
                      ),
                      u.arc(
                        y.cx,
      ...
      return (
        ...
        (c.endAngle = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : by(+t)), c)
            : o;
        }),
        (c.padAngle = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : by(+t)), c)
            : a;
        }),
        (c.context = function (t) {
        ...
        if (i)
          if ("true" === i) i = !0;
            ...
            if (
              ...
              continue;
            na && r[4] && !r[7] && (i = i.replace(/-/g, "/").replace(/T/, " ")),
              (i = new Date(i));
          } else i = e;
        else i = null;
        t[n] = i;
    ...
    (t.contourDensity = function () {
      ...
      return (
        (l.x = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : yo(+n)), l)
            : t;
        }),
        (l.y = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : yo(+t)), l)
            : n;
        }),
        (l.weight = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : yo(+t)), l)
            : e;
        }),
        (l.size = function (t) {
    ...
    (t.curveBundle = E_),
    (t.curveCardinal = z_),
    (t.curveCardinalClosed = D_),
    (t.curveCardinalOpen = L_),
    (t.curveCatmullRom = B_),
    (t.curveCatmullRomClosed = Y_),
    (t.curveCatmullRomOpen = H_),
    (t.curveLinear = By),
    ...
    (t.forceCollide = function (t) {
      ...
      function o() {
        for (var t, o, u, c, f, s, l, h = n.length, d = 0; d < i; ++d)
          for (o = ma(n, Na, Ta).visitAfter(a), t = 0; t < h; ++t)
            (u = n[t]),
              (s = e[u.index]),
              (l = s * s),
              (c = u.x + u.vx),
      ...
      return (
        "function" != typeof t && (t = pa(null == t ? 1 : +t)),
        ...
        (o.radius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : pa(+n)), u(), o)
            : t;
        }),
        o
      );
    ...
    (t.forceLink = function (t) {
      ...
      function s(r) {
        for (var i = 0, a = t.length; i < f; ++i)
          for (var u, c, s, l, h, d, p, v = 0; v < a; ++v)
            (c = (u = t[v]).source),
              (l = (s = u.target).x + s.vx - c.x - c.vx || va()),
              (h = s.y + s.vy - c.y - c.vy || va()),
              (l *= d =
      ...
      function l() {
        if (r) {
          ...
          for (u = 0, i = new Array(f); u < s; ++u)
            ((c = t[u]).index = u),
              "object" != typeof c.source && (c.source = Sa(l, c.source)),
              "object" != typeof c.target && (c.target = Sa(l, c.target)),
      ...
      return (
        ...
        (s.strength = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : pa(+t)), h(), s)
            : u;
        }),
        (s.distance = function (t) {
          return arguments.length
            ? ((c = "function" == typeof t ? t : pa(+t)), d(), s)
            : c;
        }),
        s
      );
    ...
    (t.forceManyBody = function () {
      ...
      return (
        ...
        (c.strength = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : pa(+t)), f(), c)
            : i;
        }),
    ...
    (t.forceRadial = function (t, n, e) {
      ...
      return (
        ...
        (u.strength = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : pa(+t)), c(), u)
            : a;
        }),
        (u.radius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : pa(+n)), c(), u)
            : t;
        }),
        (u.x = function (t) {
    ...
    (t.forceX = function (t) {
      ...
      return (
        "function" != typeof t && (t = pa(null == t ? 0 : +t)),
        (o.initialize = function (t) {
          (n = t), a();
        }),
        (o.strength = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : pa(+t)), a(), o)
            : i;
        }),
        (o.x = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : pa(+n)), a(), o)
            : t;
        }),
        o
      );
    ...
    (t.formatDefaultLocale = Xa),
    (t.formatLocale = ja),
    (t.formatSpecifier = La),
    (t.geoAlbers = tl),
        ...
        (s.translate = function (t) {
          ...
          return (
            ...
            (r = u
              ...
              .clipExtent([
                [o - 0.425 * n + Ja, s + 0.12 * n + Ja],
                [o - 0.214 * n - Ja, s + 0.234 * n - Ja],
              ])
              .stream(f)),
            (i = c
              .translate([o - 0.205 * n, s + 0.212 * n])
              .clipExtent([
                [o - 0.214 * n + Ja, s + 0.166 * n + Ja],
                [o - 0.115 * n - Ja, s + 0.234 * n - Ja],
              ])
              .stream(f)),
            l()
          );
    ...
    (t.geoAzimuthalEqualAreaRaw = rl),
    (t.geoAzimuthalEquidistant = function () {
      return Ws(il).scale(79.4188).clipAngle(179.999);
    }),
    (t.geoAzimuthalEquidistantRaw = il),
    (t.geoBounds = function (t) {
      var n, e, r, i, o, a, u;
      if (
        ((Qu = Zu = -($u = Wu = 1 / 0)), (ec = []), ku(t, xc), (e = ec.length))
      ) {
        for (ec.sort(Cc), n = 1, o = [(r = ec[0])]; n < e; ++n)
          Pc(r, (i = ec[n])[0]) || Pc(r, i[1])
            ? (Ec(r[0], i[1]) > Ec(r[0], r[1]) && (r[1] = i[1]),
              Ec(i[0], r[1]) > Ec(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i));
        for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
          (i = o[n]),
            (u = Ec(r[1], i[0])) > a && ((a = u), ($u = i[0]), (Zu = r[1]));
      }
      return (
        (ec = rc = null),
        $u === 1 / 0 || Wu === 1 / 0
    ...
    (t.geoCentroid = function (t) {
      ...
      return i < tu &&
        ...
        (e = sc),
        (r = lc),
        oc < Ja && ((n = ac), (e = uc), (r = cc)),
        (i = n * n + e * e + r * r) < tu)
        ? [NaN, NaN]
        : [fu(e, n) * ou, mu(r / yu(i)) * ou];
    }),
    (t.geoCircle = function () {
      ...
      return (
        (a.center = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : Hc([+t[0], +t[1]])), a)
            : e;
        }),
        (a.radius = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Hc(+t)), a)
            : r;
        }),
        (a.precision = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : Hc(+t)), a)
            : i;
        }),
        a
      );
    ...
    (t.geoIdentity = function () {
      ...
      return (o = {
        ...
        scale: function (t) {
          return arguments.length
            ? ((l = _l((a = +t) * f, a * s, u, c)), p())
            : a;
        },
        translate: function (t) {
          return arguments.length
            ? ((l = _l(a * f, a * s, (u = +t[0]), (c = +t[1]))), p())
            : [u, c];
        },
        reflectX: function (t) {
          return arguments.length
            ? ((l = _l(a * (f = t ? -1 : 1), a * s, u, c)), p())
            : f < 0;
        },
        reflectY: function (t) {
          return arguments.length
            ? ((l = _l(a * f, a * (s = t ? -1 : 1), u, c)), p())
            : s < 0;
        },
    ...
    (t.geoNaturalEarth1Raw = bl),
    (t.geoOrthographic = function () {
      return Ws(ml)
        .scale(249.5)
        .clipAngle(90 + Ja);
    }),
    (t.geoOrthographicRaw = ml),
    (t.geoPath = function (t, n) {
      ...
      return (
        ...
        (o.projection = function (n) {
          return arguments.length
            ? ((e = null == n ? ((t = null), Bf) : (t = n).stream), o)
            : t;
        }),
        (o.context = function (t) {
          return arguments.length
            ? ((r = null == t ? ((n = null), new qs()) : new Ts((n = t))),
    ...
    (t.interpolateCool = fy),
    (t.interpolateCubehelix = $e),
    (t.interpolateCubehelixDefault = uy),
    (t.interpolateCubehelixLong = We),
    (t.interpolateDate = ye),
    ...
    (t.interpolateGreys = ty),
    (t.interpolateHcl = Xe),
    (t.interpolateHclLong = Ve),
    (t.interpolateHsl = Ie),
    (t.interpolateHslLong = He),
    ...
    (t.interpolateMagma = gy),
    (t.interpolateNumber = _e),
    (t.interpolateObject = be),
    (t.interpolateOrRd = zg),
    (t.interpolateOranges = ay),
    (t.interpolatePRGn = sg),
    (t.interpolatePiYG = hg),
    (t.interpolatePlasma = _y),
    (t.interpolatePuBu = Lg),
    (t.interpolatePuBuGn = Dg),
    (t.interpolatePuOr = pg),
    (t.interpolatePuRd = Og),
    (t.interpolatePurples = ey),
    ...
    (t.interpolateRdBu = gg),
    (t.interpolateRdGy = _g),
    (t.interpolateRdPu = Fg),
    (t.interpolateRdYlBu = mg),
    (t.interpolateRdYlGn = wg),
    (t.interpolateReds = iy),
    (t.interpolateRgb = he),
    (t.interpolateRgbBasis = pe),
    (t.interpolateRgbBasisClosed = ve),
    (t.interpolateRound = Ne),
    (t.interpolateSinebow = function (t) {
      var n;
      return (
        (t = (0.5 - t) * Math.PI),
        (ly.r = 255 * (n = Math.sin(t)) * n),
        (ly.g = 255 * (n = Math.sin(t + hy)) * n),
        (ly.b = 255 * (n = Math.sin(t + dy)) * n),
        ly + ""
      );
    }),
    (t.interpolateSpectral = Ng),
    (t.interpolateString = we),
    (t.interpolateTransformCss = Re),
    (t.interpolateTransformSvg = De),
    ...
    (t.interpolateViridis = vy),
    (t.interpolateWarm = cy),
    (t.interpolateYlGn = jg),
    (t.interpolateYlGnBu = Ig),
    (t.interpolateYlOrBr = Vg),
    (t.interpolateYlOrRd = $g),
    ...
    (t.nest = function () {
      ...
      function o(e, i, a, u) {
        ...
        for (
          var c, f, s, l = -1, h = e.length, d = r[i++], p = ao(), v = a();
          ++l < h;
    ...
    (t.pack = function () {
      ...
      function i(i) {
        return (
          ...
          (i.y = e / 2),
          t
            ? i.eachBefore(Ql(t)).eachAfter(Kl(r, 0.5)).eachBefore(Jl(1))
            : i
                .eachBefore(Ql(Zl))
                .eachAfter(Kl($l, 1))
                .eachAfter(Kl(r, i.r / Math.min(n, e)))
                .eachBefore(Jl(Math.min(n, e) / (2 * i.r))),
          i
        );
      }
      return (
    ...
    (t.radialLine = Zy),
    (t.randomBates = Ah),
    (t.randomExponential = Sh),
    (t.randomIrwinHall = Th),
    ...
    (t.ribbon = function () {
      ...
      function a() {
        ...
        if (
          ...
          o.arc(0, 0, s, l, h),
          (l === g && h === y) ||
            (o.quadraticCurveTo(0, 0, v * Fi(g), v * Yi(g)),
            o.arc(0, 0, v, g, y)),
      ...
      return (
        (a.radius = function (t) {
          return arguments.length
            ? ((e = "function" == typeof t ? t : $i(+t)), a)
            : e;
        }),
        (a.startAngle = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : $i(+t)), a)
            : r;
        }),
        (a.endAngle = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : $i(+t)), a)
            : i;
        }),
        (a.source = function (n) {
    ...
    (t.scaleIdentity = function t(n) {
      ...
      return (
        ...
        (n = arguments.length ? Ph.call(n, Lh) : [0, 1]),
        Gh(r)
      );
    }),
    (t.scaleImplicit = Rh),
    ...
    (t.scaleThreshold = function t() {
      ...
      return (
        (a.domain = function (t) {
          return arguments.length
            ? ((e = zh.call(t)), (o = Math.min(e.length, r.length - 1)), a)
            : e.slice();
        }),
        (a.range = function (t) {
          return arguments.length
            ? ((r = zh.call(t)), (o = Math.min(e.length, r.length - 1)), a)
            : r.slice();
        }),
    ...
    (t.scaleTime = function () {
      return kh.apply(
        Hv(Id, Fd, Ad, Md, xd, bd, yd, dd, t.timeFormat).domain([
          new Date(2e3, 0, 1),
          new Date(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.scaleUtc = function () {
      return kh.apply(
        Hv(dp, lp, Qd, $d, Vd, jd, yd, dd, t.utcFormat).domain([
          Date.UTC(2e3, 0, 1),
          Date.UTC(2e3, 0, 2),
        ]),
        arguments
    ...
    (t.stack = function () {
      ...
      return (
        (i.keys = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : by(Jy.call(n))), i)
            : t;
        }),
        (i.value = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : by(+t)), i)
            : r;
        }),
        (i.order = function (t) {
          return arguments.length
            ? ((n =
                null == t ? eb : "function" == typeof t ? t : by(Jy.call(t))),
              i)
            : n;
        }),
        (i.offset = function (t) {
    ...
    (t.stackOrderAppearance = ib),
    (t.stackOrderAscending = ab),
    ...
    (t.symbol = function () {
      ...
      return (
        (r.type = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : by(n)), r)
            : t;
        }),
        (r.size = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : by(+t)), r)
            : n;
        }),
    ...
    (t.timeFormatLocale = _p),
    (t.timeFriday = Pd),
    (t.timeFridays = Od),
    (t.timeHour = xd),
    (t.timeHours = wd),
    (t.timeInterval = hd),
    (t.timeMillisecond = dd),
    (t.timeMilliseconds = pd),
    (t.timeMinute = bd),
    (t.timeMinutes = md),
    (t.timeMonday = Sd),
    (t.timeMondays = Dd),
          ...
          for (var n, e, r, i, o, a = new hh(t, 0), u = [a]; (n = u.pop()); )
            if ((r = n._.children))
              for (
                ...
                u.push((e = n.children[i] = new hh(r[i], i))), (e.parent = n);
            ...
            for (
              ...
              (c = ch(c)),
                ...
                (i = u.z + l - o.z - f + t(u._, o._)) > 0 &&
                  (sh(lh(u, n, r), n, i), (f += i), (s += i)),
                (l += u.m),
                (f += o.m),
                (h += c.m),
                (s += a.m);
            u && !fh(a) && ((a.t = u), (a.m += l - s)),
              o && !ch(c) && ((c.t = o), (c.m += f - h), (r = n));
          }
          return r;
        })(n, i, n.parent.A || r[0]);
      }
    ...
    (t.treemap = function () {
      ...
      return (
        ...
        (s.paddingTop = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Wl(+t)), s)
            : a;
        }),
        (s.paddingRight = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : Wl(+t)), s)
            : u;
        }),
        (s.paddingBottom = function (t) {
          return arguments.length
            ? ((c = "function" == typeof t ? t : Wl(+t)), s)
            : c;
        }),
        (s.paddingLeft = function (t) {
          return arguments.length
            ? ((f = "function" == typeof t ? t : Wl(+t)), s)
            : f;
        }),
        s
      );
    ...
    (t.voronoi = function () {
      ...
      function r(r) {
        return new Xb(
          r.map(function (e, i) {
            var o = [
              Math.round(t(e, i, r) / Yb) * Yb,
              Math.round(n(e, i, r) / Yb) * Yb,
            ];
      ...
      return (
        ...
        (r.x = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : cb(+n)), r)
            : t;
        }),
        (r.y = function (t) {
          return arguments.length
            ? ((n = "function" == typeof t ? t : cb(+t)), r)
            : n;
        }),
        (r.extent = function (t) {
          return arguments.length
    ...
    (t.zoom = function () {
      ...
      function S() {
        if (this.__zooming) {
          var e,
            ...
            s = c.length;
          for (Kb(), n && (n = clearTimeout(n)), u.taps = 0, e = 0; e < s; ++e)
      ...
      return (
        ...
        (w.prototype = {
          ...
          emit: function (t) {
            kt(new Gb(g, t, this.that.__zoom), h.apply, h, [
              t,
              this.that,
              this.args,
            ]);
        ...
        (g.wheelDelta = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : Vb(+t)), g)
            : a;
        }),
        (g.filter = function (t) {
          return arguments.length
            ? ((r = "function" == typeof t ? t : Vb(!!t)), g)
            : r;
        }),
        (g.touchable = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : Vb(!!t)), g)
            : u;
        }),
        (g.extent = function (t) {
          return arguments.length
