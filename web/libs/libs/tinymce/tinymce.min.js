  ...
  var eb = function (e, t) {
    ...
    Fb = function (n, e) {
      var t,
        ...
        u,
        s = "";
      if (!1 === (u = n.settings.pretelemetria.view_styles)) return "";
      "string" != typeof u &&
        (u =
  ...
  var Hb,
    ...
    ey = function (e, t, n, r) {
      (e.padd_empty_with_br || t.insert) && n[r.name]
        ...
        : (r.empty().append(new Zb("#text", 2)).value = "\xa0");
    },
    ty = function (e) {
          ...
          for (d.body = 1, r = 0; r < f; r++)
            if (
              ...
              a === i &&
                ...
                (((l = new Zb("#text", 2)).value = "\xa0"), o.replace(l));
            }
        }),
          ...
          t = Rv(
            {
              ...
              text: function (e, t) {
                ...
                f ||
                  ...
                  0 !== e.length &&
                    (((n = N("#text", 2)).raw = !!t), (d.append(n).value = e));
              },
              comment: function (e) {
