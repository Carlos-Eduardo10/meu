...
(function (window, undefined) {
  ...
  jQuery.fn.extend({
    show: function (speed, easing, callback) {
      ...
      if (speed || speed === 0) {
        return this.animate(genFx("show", 2), speed, easing, callback);
      } else {
    ...
    hide: function (speed, easing, callback) {
      if (speed || speed === 0) {
        return this.animate(genFx("hide", 2), speed, easing, callback);
      } else {
        var elem,
          display,
          i = 0,
    ...
    toggle: function (fn, fn2, callback) {
      ...
      if (jQuery.isFunction(fn) && jQuery.isFunction(fn2)) {
        ...
        this.animate(genFx("toggle", 2), fn, fn2, callback);
      }
