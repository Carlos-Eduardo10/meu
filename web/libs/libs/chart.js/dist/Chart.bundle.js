      ...
      1: [
        function (require, module, exports) {
          ...
          function getRgb(string) {
            ...
            return rgba && rgba.slice(0, 2);
          }

          function getHsl(string) {
            var hsla = getHsla(string);
            return hsla && hsla.slice(0, 2);
          }
          ...
          function keyword(rgb) {
            return reverseNames[rgb.slice(0, 2)];
          }
          ...
          function lab2xyz(lab) {
            ...
            x =
              x / 95.047 <= 0.008856
                ...
                : 95.047 * Math.pow(a / 500 + y2, 2);

            z =
              z / 108.883 <= 0.008859
                ? (z = (108.883 * (y2 - b / 200 - 16 / 116)) / 7.787)
                : 108.883 * Math.pow(y2 - b / 200, 2);
