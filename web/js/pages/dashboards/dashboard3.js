...
$(function () {
  ...
  var chart_column_basic3 = new ApexCharts(
    document.querySelector("#download-count-3"),
    option_Download_Count_3
  );

  chart_column_basic3.render();
