...
(function (global, factory) {
    ...
    function computeContainerTag(html) {
        return containerTagHash[html.substr(0, 2) // faster than using regex
        ] || 'div';
    }
    ...
    */
    ...
    function parseViewConfig(input) {
        ...
        var options = {};
        var props = refineProps(input, telemetria.view_DEF_PROPS, {}, options);
        return {
